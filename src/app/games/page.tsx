          ...
          {GAMES.map((game) => {
            ...
            return (
              <Link
                key={game.href}
                href={game.href}
                className="group flex flex-col items-start gap-4 rounded-xl border border-border bg-card/70 p-6 backdrop-blur-sm transition-colors hover:border-primary/50"
              >
