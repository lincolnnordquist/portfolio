...
export const metadata: Metadata = {
  ...
  description:
    "About Alex Rivera, a full-stack software engineer focused on developer tooling and distributed systems.",
}
    ...
    <main className="mx-auto max-w-3xl px-5 py-16 sm:py-24">
      <header className="flex flex-col gap-4">
        ...
        <p className="text-pretty text-lg leading-relaxed text-muted-foreground">
          I&apos;ve spent the last decade building software that other people
          ...
          keyboard I&apos;m usually deep in a video game, an anime backlog, or a
          Seahawks game I&apos;m too emotionally invested in.
        </p>
      </header>
        ...
        <div className="flex flex-col gap-6">
          {VALUES.map((v) => (
            <div key={v.title} className="flex flex-col gap-1.5">
              <h3 className="theme-heading text-lg font-semibold">{v.title}</h3>
        ...
        <ol className="flex flex-col">
          {EXPERIENCE.map((job, i) => (
            <li
              ...
              style={{ borderBottomWidth: i === EXPERIENCE.length - 1 ? 1 : 0 }}
            >
